...
>
    ...
    >
        ...
        <div class="w-full h-48 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
            ...
            <div x-show="!imageUrl" class="size-full flex items-center justify-center">
                <div class="text-center p-4">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">Enter a valid image URL to see a preview.</p>
                </div>
            </div>
        </div>
    </div>
